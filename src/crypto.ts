...
export async function symEncrypt(
  ...
  // Concatenate IV and encrypted data (for decryption purposes)
...
export async function symDecrypt(
  ...
  const iv = encryptedBuffer.slice(0, 12); // The first 12 bytes are the IV
  const encryptedMessage = encryptedBuffer.slice(12); // The rest is the encrypted message
